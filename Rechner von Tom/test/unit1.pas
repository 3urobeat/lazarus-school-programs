...
//quickly enable or disable buttons without having to write code multiple times
...
//Remove last number that was put in
procedure TForm1.backClick(Sender: TObject);
begin
     if SkipToCalc2 = false then
        begin
             delete (ToCalc1, Length(ToCalc1), 1);
             delete (Label1, Length(Label1), 1);
        end
     else
         begin
              delete (ToCalc2, Length(ToCalc2), 1);
              delete (Label1, Length(Label1), 1);
         end;
